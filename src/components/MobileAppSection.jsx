...
const MobileAppSection = () => {
  ...
  const downloadMobileApplication = () => {
  // Extracted file id from your link:
  const fileId = "1-3HRCEffBwj9Vjx2B3vMHZNPz5IPm8nl";
...
const handleClick = (e) => {
  e.preventDefault(); // stop jumping to #app-store
  setShowPopup(true);
};
        ...
        <div className="mobileapp-grid">
          <div className="mobileapp-phone-section">
            <div className="mobileapp-phone-mockup">
              ...
              <img
                className="mobileapp-phone-image"
                src={phone}
          ...
          <div className="mobileapp-text-section">
            ...
            <p className="mobileapp-subtitle">
              The LOOK TRACK VISION mobile application provides a lightweight
              companion interface for testing gaze tracking and blink-based
              interaction using a smartphone camera. It enables real-time
              calibration and gaze validation while preserving privacy through
              on-device processing.
            </p>

            <div className="mobileapp-download-buttons">
              <a
                onClick={downloadMobileApplication}
                href="#google-play"
                className="mobileapp-download-btn"
              >
                <svg
                  className="mobileapp-store-icon"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              {showPopup && (
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      The iOS app is currently not available. Please use Android
                      for now.
                    </p>
