...
const Chatbot = () => {
  ...
  useEffect(() => {
    ...
    if (lastUsed && Date.now() - parseInt(lastUsed) > 86400000) {
      ...
      localStorage.removeItem("chatLastUsed");
      return;
    }
          ...
          setMessages([
            {
              role: 'bot',
              content:
                '👋 Hello! I can answer questions about Look Track Vision and our gaze tracking system. How can I help you?',
              timestamp: new Date()
            }
          ]);
        }
        ...
        <div className="chatbot-container">
          ...
          <div className="chatbot-header">
            ...
            <div style={{ display: "flex", gap: "6px" }}>
              <button className="chatbot-end-btn" onClick={endChatSession} title="End Chat">🔄</button>
          ...
          <div className="chatbot-messages">
            {messages.map((message, index) => (
              <div key={index} className={`chatbot-message chatbot-message-${message.role}`}>
                {message.role === 'bot' && <div className="chatbot-message-avatar">🤖</div>}
