...
const Tutorials = () => {
  const videos = [
  {
    ...
    type: "mp4",
    src: "/videos/Application_intro.mp4",
    openUrl: "/videos/Application_intro.mp4",
    badge: "Beginner",
    icon: "🎥",
  },
  {
    title: "Tutorial 02: Calibration & Usage",
    subtitle: "Step-by-step calibration guide and how to use the system effectively.",
    type: "mp4",
    src: "/videos/tutorial2.mp4",
    openUrl: "/videos/tutorial2.mp4",
    badge: "Advanced",
    icon: "🎬",
  },
];
